...
export default function Navebar() {
  ...
  useEffect(() => {
    if (storedUser) {
      ...
      axios
        .get("https://darttag-server.onrender.com/api/activeuser", {
  ...
  const AttendanceLog = (item) => {
    ...
    if (storedUser && storedUser.email) {
      ...
      axios.post('https://darttag-server.onrender.com/api/attendenceLog', data)
        .then(response => {
  ...
  const getTodayAttendence = () => {
    const storedUser = JSON.parse(sessionStorage.getItem("user"));
    axios
      .get(`https://darttag-server.onrender.com/api/singleAttendence/${storedUser.email}`)
      .then((response) => {
  ...
  const UpdateAttendence = (item) => {
    ...
    if (storedUser && storedUser.email) {
      ...
      axios.post(`https://darttag-server.onrender.com/api/updateAttendence/${data.updateID}`, data)
        .then(response => {
  ...
  return (
    <>
      ...
      <header>
        <Navbar bg="yellow " variant="dark" expand="xl" className="p-3">
          ...
          />
            ...
            <h4 className=" text-blue-500 text-2xl">DART</h4>
            <h4 className=" text-white text-2xl">TAG</h4>

...
function App() {
  ...
  const getData = () => [
    axios
      .get(`https://darttag-server.onrender.com/api/allAttendence/${storedUser.email}`)
      .then((response) => {
  ...
  const getallData = () => [
    axios
      .get('https://darttag-server.onrender.com/api/allEmpAttend')
      .then((response) => {
        console.log("response", response.data);
        return setAllItems(response.data);
      })
  ...
  const getOneUserData = (selectedUser) => [
    axios
      .get(`https://darttag-server.onrender.com/api/allAttendence/${selectedUser}`)
      .then((response) => {
        console.log("response", response.data);
        return setAllItems(response.data);
      })
...
{/* <h6 className='text-black px-7'>Total working days</h6>

<h6 className='text-black px-7'>Present Days</h6>
<h6 className='text-black px-7'>Absent Days</h6> */}
...
function App() {
  ...
  const getData = () => [
    axios
      .get(`https://darttag-server.onrender.com/api/allLeave/${storedUser.email}`)
      .then((response) => {
  ...
  const getallData = () => [
    axios
      .get('https://darttag-server.onrender.com/api/EmpLeave')
      .then((response) => {
        console.log("response", response.data);
        return setAllItems(response.data);
      })
  ...
  const gettotalleaves = () => [
    axios
      .get(`https://darttag-server.onrender.com/api/totalempleaves/${storedUser.email}`)
      .then((response) => {
  ...
  const getOneUserData = (selectedUser) => [
    axios
      .get(`https://darttag-server.onrender.com/api/allLeave/${selectedUser}`)
      .then((response) => {
        console.log("response", response.data);
        return setAllItems(response.data);
      })

...
function Leave() {
  ...
  const handleSubmit = () => {
    ...
    if (storedUser && storedUser.email)  {
      ...
      axios.post('https://darttag-server.onrender.com/api/applyleave', data)
        .then(response => {
  ...
  const createLeaveCount = (data) => {
    axios.post('https://darttag-server.onrender.com/api/addLeaveCount', data)
      .then(response => {
        console.log('user applied leave:', response.data);
  ...
  const updateLeaveCount = (data) => {
    console.log();
    axios.post(`https://darttag-server.onrender.com/api/UpdateLeaveCount/${data.updateID}`, data)
      .then(response => {
        console.log('user applied leave:', response.data);
        toast.success("Leave applied Successfully");
        window.location.href = "/#LeaveReport"
